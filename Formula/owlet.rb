class Owlet < Formula
  ...
  on_linux do
    on_intel do
      url "https://redist.ctr-electronics.com/tools/owlet/26.70.0/owlet-26.70.0-linuxx86-64"
      sha256 "081b0a122296fd12e845553f161446fefe16891f0bdc44d8679edb4785a99baa"
    end

    on_arm do
      url "https://redist.ctr-electronics.com/tools/owlet/26.70.0/owlet-26.70.0-linuxarm64"
